...
// 인자 : (StreamBuffer **) 직렬화버퍼 2중포인터, (int) 고유번호, (BYTE) 방향, (Pos) 위치, (BYTE) HP
// 리턴 :
/*----------------*////////////////////////*----------------*/
...
// 인자 : (StreamBuffer **) 직렬화버퍼 2중포인터, (int) 고유번호
// 리턴 :
/*----------------*////////////////////////*----------------*/
...
// 인자 : (StreamBuffer **) 직렬화버퍼 2중포인터, (int) 고유번호, (BYTE) 방향, (Pos) 위치
// 리턴 :
/*----------------*////////////////////////*----------------*/
...
// ::MakePacket_Damage
// 설명 : 데미지 패킷 만들기
// 인자 : (StreamBuffer **) 직렬화버퍼 2중포인터, (int) 공격자 고유번호, (int) 피격자 고유번호, (BYTE) 피격후HP
// 리턴 :
/*----------------*////////////////////////*----------------*/
...
// 인자 : (StreamBuffer **) 직렬화버퍼 2중포인터, (int) 고유번호, (Pos) 위치
// 리턴 :
/*----------------*////////////////////////*----------------*/
...
// ::UniCast
// 설명 : 세션에게 패킷 보내기
// 인자 : (StreamBuffer *) 직렬화버퍼 포인터, (Session *) 세션 포인터, (bool) delete여부
// 리턴 :
/*----------------*////////////////////////*----------------*/
...
// ::BroadCast_All
// 설명 : 전체에게 패킷 보내기
// 인자 : (StreamBuffer *) 직렬화버퍼 포인터, (Session *) 세션 포인터, (bool) 세션에게 전송 여부
// 리턴 :
/*----------------*////////////////////////*----------------*/
